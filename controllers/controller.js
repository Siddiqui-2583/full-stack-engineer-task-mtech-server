...
export const insertProduct = (req, res) => {
    ...
    let query = "'" + productId + "','" + product.title + "','" + product.unitPrice + "'";
    console.log(query);
    pool.query(
      "INSERT INTO Product (productId,title,unitPrice) VALUES (" +
        query +
        ")",
...
export const placeOrder = (req, res) => {
    ...
    products.forEach((product) => {
        ...
        console.log("inserting data into Postgresql");
        let query =
            "'" + orderId + "','" + product.productId + "','" + product.title+ "','" + product.quantity + "','" +  product.subtotal + "','" +  totalPrice + "'";
        console.log(query);
